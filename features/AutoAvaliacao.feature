Feature: auto-avaliação
		As a aluno com o nome “Cicrano da Silva”
		I want to adicionar as notas da auto-avaliação das minhas metas e visualizar os conceitos atribuídos pelos professores
		So that eu possa registrar a minha auto-avaliação no sistema

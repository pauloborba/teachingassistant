...
Scenario: Visuliazing discrepancy percentage
	Given that lorem ipsum 
	And lorem ipsum
	Then lorem ipson adionando variadas coisas aqui para mudar ne etc
	Vou até colocar mais uma linha para causar certo impacto

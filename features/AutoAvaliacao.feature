...
Scenario: adicionar conceitos de auto-avaliação incompletas
    ...
    And eu seleciono para salvaros conceitos
...
Scenario: não existe discrepância entre as notas dos alunos e do professor
    ...
    And o aluno "Eduardo" e possui conceitos "MPA", "MPA",  "MPA", "MANA", "MPA" e "MPA",  "de auto-avaliação" para as metas de "entender requisitos", "elicitar requisitos", "especificar requisitos", "entender conceitos de gerência" e "realizar testes sólidos", respectivamente

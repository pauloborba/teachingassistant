...
cucumber_1.defineSupportCode(function ({ Given, When, Then }) {
    ...
    Given(/^I cannot see a student with CPF "(.*?)" in the students list$/, (cpf) => __awaiter(this, void 0, void 0, function* () {
    ...
    When(/^I try to register the student "(.*?)" with CPF "(.*?)"$/, (name, cpf) => __awaiter(this, void 0, void 0, function* () {
    ...
    Then(/^I can see "(.*?)" with CPF "(.*?)" in the students list$/, (name, cpf) => __awaiter(this, void 0, void 0, function* () {
